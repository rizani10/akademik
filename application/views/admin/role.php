<div id="content">
    <div class="container-fluid">
        ...
        <a href="" class="btn btn-primary mb-3" data-toggle="modal" data-target="#roleUser">
                                ...
                                <tbody>
                                    ...
                                    foreach ($role as $r) : ?>
                                        <tr>
                                            ...
                                            <td><?= $r['role'] ?></td>
                                            <td>
                                                <a href="<?= base_url('admin/roleakses/') . $r['id']; ?>" class="badge badge-success">Akses</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
...
<!-- modal tambah -->
<div class="modal fade" id="roleUser" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <form action="<?= base_url('menu'); ?>" method="post">
                <div class="modal-body">
                    <div class="form-group">
                        <input type="text" class="form-control" name="menu" id="menu" placeholder="Nama Role">
                    </div>
