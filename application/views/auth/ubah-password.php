            ...
            <div class="col-md-5">
                <div class="card o-hidden border-0 shadow-lg my-5">
                    ...
                    <div class="p-5">
                        ...
                        <form class="user" method="POST" action="<?= base_url('auth/getUbahPassword') ?>">
                            ...
                            <div class="form-group">
                                <input type="password" class="form-control form-control-user" id="password2" name="password2" placeholder="Ulangi Masukkan Password Baru">
